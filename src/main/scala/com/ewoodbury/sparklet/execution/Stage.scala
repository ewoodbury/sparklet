...
/**
 * Represents a stage: a sequence of narrow transformations that can be executed together.
 * Each stage operates on partitions independently without requiring shuffles.
 */
